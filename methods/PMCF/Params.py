...
def ParseArgs():
	...
	parser.add_argument('--save_path', default='PMCF', help='file name to save model and training record')
	parser.add_argument('--tau', default=0.1, type=float, help='temperature to adjust the PPR distribution')
	parser.add_argument('--latdim', default=320, type=int, help='embedding size')
	parser.add_argument('--head', default=16, type=int, help='number of heads in attention')
